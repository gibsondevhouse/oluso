...
<style>
  ...
  .panel, .mapping { display: grid; gap: 16px; border: 1px solid var(--color-border); border-radius: var(--radius-surface); background: var(--color-surface); padding: 20px; }
  .mapping { border-radius: var(--radius-control); background: var(--color-surface-subtle); } .targets { display: flex; gap: 12px; flex-wrap: wrap; } a { color: var(--color-action); } details { margin-top: 8px; } summary { color: var(--color-action); cursor: pointer; } pre { max-height: 300px; overflow: auto; border: 1px solid var(--color-border); border-radius: var(--radius-control); background: var(--color-surface-inset); padding: 12px; white-space: pre-wrap; }
  ...
  button, .primary { border: 1px solid var(--color-border); border-radius: var(--radius-control); background: var(--color-surface); color: var(--color-text); padding: 8px 11px; cursor: pointer; } .primary { border: 0; background: var(--color-action); color: #fff; font-weight: 780; }
