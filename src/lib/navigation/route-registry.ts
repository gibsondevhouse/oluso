...
export const APP_ROUTES: AppRoute[] = [
  {
    path: "/home",
    title: "Home",
    summary: "Review current context, continue work, attention items, local activity, and safe starting actions.",
    section: "Home",
    kind: "home",
  },
  {
    path: "/search",
    title: "Search",
    summary: "Search current typed records and deliberately retained legacy/reference records.",
    section: "Home",
    kind: "global-search",
  },
  {
    path: "/activity",
    title: "Activity",
    summary: "Review immutable record revisions and clearly labeled limited legacy history.",
    section: "Home",
    kind: "activity",
  },
  {
